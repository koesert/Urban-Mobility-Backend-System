...
class TestCheckPermission:
    ...
    @patch('auth.decrypt_username')
    @patch('auth.encrypt_username')
    def test_super_admin_permissions(self, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
    ...
    @patch('auth.decrypt_username')
    @patch('auth.encrypt_username')
    def test_unknown_role_permissions(self, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
...
class TestRequirePermission:
    ...
    def test_require_permission_success(self, mock_validate, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
    ...
    @patch('auth.decrypt_username')
    @patch('auth.encrypt_username')
    def test_require_permission_denied(self, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
...
class TestUpdatePasswordAdditional:
    ...
    @patch('auth.decrypt_username')
    @patch('auth.encrypt_username')
    def test_update_password_same_as_old(self, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
    ...
    @patch('auth.decrypt_username')
    @patch('auth.encrypt_username')
    def test_update_password_validation_error(self, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
        ...
        with patch('auth.validate_password', side_effect=ValidationError("Password too short")):
    ...
    @patch('auth.decrypt_username')
    @patch('auth.encrypt_username')
    def test_update_password_user_not_found_in_db(self, mock_encrypt, mock_decrypt, mock_verify, mock_conn):
...
class TestGetUserByUsername:
    ...
    @patch('auth.encrypt_username')
    @patch('auth.validate_username')
    def test_get_user_by_username_not_found(self, mock_validate, mock_encrypt, mock_conn):
    ...
    def test_get_user_by_username_invalid_format(self):
        ...
        with patch('auth.validate_username', side_effect=ValidationError("Invalid format")):
...
class TestListUsersByRole:
    ...
    def test_list_users_by_role_no_filter(self, mock_decrypt, mock_conn):
        ...
        mock_cursor.fetchall.return_value = [
            ...
            (2, 'encrypted_engineer', 'service_engineer', 'Engineer', 'User', '2025-01-02'),
...
class TestLoginFailurePaths:
    ...
    def test_login_user_not_found_logs_activity(self, mock_log, mock_validate, mock_encrypt, mock_conn):
    ...
    @patch('auth.verify_password')
    @patch('auth.log_activity')
    def test_login_wrong_password_logs_activity(self, mock_log, mock_verify, mock_decrypt, mock_encrypt, mock_conn):
        ...
        assert any("Unsuccessful login" in call and "wrong password" in call for call in calls)
